@testset "stop_conditions" begin
    episode_end_obs = RL.EnvObservation(;observation=nothing, reward=1.0, isdone=true)
    episode_not_end_obs = RL.EnvObservation(;observation=nothing, reward=1.0, isdone=false)
