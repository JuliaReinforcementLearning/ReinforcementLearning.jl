...
"""
RLBase.state(env::TigerProblemEnv, ::Observation{Int}, ::DefaultPlayer) = state(env, Observation{Int}())

function RLBase.state(env::TigerProblemEnv, ::Observation, ::DefaultPlayer)
...
RLBase.state_space(::TigerProblemEnv, ::Observation) = Base.OneTo(4)
