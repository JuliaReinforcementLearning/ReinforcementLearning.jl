...
RLBase.act!(env::AbstractEnvWrapper, args...; kwargs...) = RLBase.act!(env[], args...; kwargs...)
...
# avoid ambiguous
RLBase.state(env::AbstractEnvWrapper, ss::RLBase.AbstractStateStyle, player::Player) =
    state(env[], ss, player)
...
RLBase.state_space(env::AbstractEnvWrapper, ss::RLBase.AbstractStateStyle) =
    state_space(env[], ss)
RLBase.state_space(env::AbstractEnvWrapper, ss::RLBase.AbstractStateStyle, player::Player) =
    state_space(env[], ss, player)
