...
mutable struct PrioritizedDQNLearner{Tq<:AbstractApproximator, Tt<:AbstractApproximator, Tf, S<:Union{Int, Nothing}, R<:AbstractRNG} <: AbstractLearner
    approximator::Tq
...
"""
(learner::PrioritizedDQNLearner)(obs) = obs |>
    get_state |>
...
function (agent::Agent{<:QBasedPolicy{<:PrioritizedDQNLearner},<:CircularCompactPSARTSATrajectory})(
    ::PostActStage,
    obs,
)
