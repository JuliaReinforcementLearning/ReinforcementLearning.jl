...
function RLBase.update!(L::DoubleLearner{<:TDLearner}, t::AbstractTrajectory, ::AbstractEnv, ::PostEpisodeStage)
    if rand(L.rng, Bool)
        L, Lₜ = L.L1, L.L2
    else
        L, Lₜ = L.L2, L.L1
...
function RLBase.update!(L::DoubleLearner{<:TDLearner}, t::AbstractTrajectory, ::AbstractEnv, ::PreActStage)
    if rand(L.rng, Bool)
        L, Lₜ = L.L1, L.L2
    else
        L, Lₜ = L.L2, L.L1
