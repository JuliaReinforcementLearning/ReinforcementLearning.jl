...
@testset "MADDPG_Learner" begin
    ...
    @testset "MADDPG_Pettingzoo_MPE" begin
        for seed ∈ seeds
            test_maddpg_simple_spread_env(1000, 100, seed) #pass
            test_maddpg_simple_spread_env(2, 100, seed)
            test_maddpg_simple_spread_env(2, 20, seed) #pass
        end
    end
    @testset "MADDPG_pistonball" begin
        for seed ∈ seeds
            test_maddpg_pistonball_env(1000, 490, seed) #pass
            test_maddpg_pistonball_env(2, 100, seed) #pass
            test_maddpg_pistonball_env(13, 20, seed) #pass
        end
    end
end