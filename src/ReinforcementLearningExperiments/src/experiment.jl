export @experiment_cmd, @E_cmd, Experiment, list_experiments
...
function Experiment(::Val{S}, ::Val{M}, ::Val{E}, x::Any) where {S,M,E}
    name = "$(S)_$(M)_$(E)"
    @error "Can not find any experiment id starting from $name."
end