...
function circular_RTSA_buffer(
    ...
    CircularTurnBuffer{RTSA, Tuple{reward_eltype, terminal_eltype, state_eltype, action_eltype}, typeof(buffers)}(buffers)
end
...
function circular_PRTSA_buffer(
    ...
    CircularTurnBuffer{PRTSA, Tuple{priority_eltype, reward_eltype, terminal_eltype, state_eltype, action_eltype}, typeof(buffers)}(buffers)
end
