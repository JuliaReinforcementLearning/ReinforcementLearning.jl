...
function RL.Experiment(
    ...
    create_greedy_explorer() =
        EpsilonGreedyExplorer(kind = :exp, ϵ_stable = 0.01, decay_steps = 500, rng = rng)

    create_random_explorer() = EpsilonGreedyExplorer(ϵ_stable = 1.0, rng = rng)
    ...
    stop_condition =
        StopAfterStep(trajectory_num + 1, is_show_progress = !haskey(ENV, "CI"))
    ...
    Experiment(
        ...
        stop_condition,
        hook,
        "# Collect $type CartPole dataset generated by BasicDQN",
    )
end
