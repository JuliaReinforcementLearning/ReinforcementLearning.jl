...
# description: Collect dataset generated by SAC
# date: 2021-09-17
...
function RL.Experiment(
    ...
    Experiment(agent, env, stop_condition, hook, "# Collect $type dataset generated by SAC")
end

function gen_JuliaRL_dataset(dataset_size::Int, type::AbstractString)
